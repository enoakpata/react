...
const HelloWorld5: React.FC<Props> = ({ name = "Eno" }) => {
...
*/
  ...
  useEffect(() => {
    window.alert(
      `Hello ${nameToGreet}, be aware that you have clicked ${count} time(s).`
    );
  ...
  return (
    <div className="flex flex-col space-y-3">
      ...
      <p>
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white fontbold py-2 px-4 rounded"
