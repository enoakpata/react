...
import { UserFetched } from './type_defs'
type Props = {
                ...
                <table className="border-separate border-spacing-2 border border-slate-400">
                    <thead>
                        <tr>
                            ...
                            <th className='border border-slate-300'>Value</th></tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className='border border-slate300'>{user.username}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className='border border-slate300'>{user.address.street}</td>
                        </tr>
                        <tr>
